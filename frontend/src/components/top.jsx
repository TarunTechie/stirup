        ...
        <header className="flex bg-peach/95 px-2 justify-between h-24 items-center fixed z-10 w-full top-0">
            ...
            {user ? (
                <div className="relative grid" onMouseOver={handleMenuOpen} onMouseLeave={handleMenuClose}>
                    ...
                    {menuOpen && (
                        <div
                            className="absolute right-0 z-10 mt-12 w-56 origin-top-right border-[.1px]  border-orange bg-white/75 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                            role="menu"
                        ...
                        >
                            <div role="none">
                                <h1 className=" font-bold text-orange block px-4 py-2 hover:bg-orange hover:text-white" role="menuitem" tabIndex="-1" id="menu-item-0">
                                    Profile
                                </h1>
                                <h1 className=" font-bold text-orange block px-4 py-2 hover:bg-orange hover:text-white" role="menuitem" tabIndex="-1" id="menu-item-0">
                                    Your Choices
                                </h1>
                                <h1 className="font-bold text-orange block px-4 py-2 hover:bg-orange hover:text-white" role="menuitem" tabIndex="-1" id="menu-item-3" onClick={handleLogout}>
                                        Logout
                                   </h1>
                            </div>
                        </div>
