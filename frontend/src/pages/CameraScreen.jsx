...
try {
      ...
      const predictedValue = result.outputs[0].data.concepts[0].name;
      setIngredients([...ingredients, predictedValue]);
      setShow(true);
    } catch (error) {
...
const handleSubmit = async (e) => {
  ...
  return(
    ...
    <div className="pt-10">
        ...
        <div {...getRootProps()}>
          <input {...getInputProps()} />
          <button className="cambtn hover:bg-orange hover:text-white" onClick={handleSubmit}>
      ...
      {show &&<Link to="/recipe"><button className="cambtn hover:bg-orange hover:text-white" onClick={getRecipe}>
      <h1>Search Recipe</h1>
